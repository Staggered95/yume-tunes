...
const Logo = ({ className = "w-12 h-12" }) => {
    return (
        ...
        >
            <defs>
                {/* We map specifically to your --logo-color-start/end 
                  defined in your @theme. We include fallbacks just in case 
                  of SSR or slow CSS loading.
                */}
                <linearGradient id="yt-grad" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop 
                        offset="0%" 
                        stopColor="var(--color-logo-color-start, #E056FD)" 
                    />
                    <stop 
                        offset="100%" 
                        stopColor="var(--color-logo-color-end, #8258FA)" 
                    />
                </linearGradient>
            ...
            <path
                ...
                fill="var(--color-logo-text-color, #F2F2F5)"
