                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
                    ...
                    <div className="md:col-span-3 flex flex-col md:items-end gap-8 pt-2 sm:pt-0" ref={menuRef}>
                        ...
                        <div className="flex items-center gap-5 mt-2 md:mt-auto">
                            ...
                            <a href="https://github.com/Staggered95/yume-tunes" target='_blank' aria-label="View source on GitHub" className="text-text-muted hover:text-accent-primary transition-colors hover:-translate-y-1 transform duration-300">
