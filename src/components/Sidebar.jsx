...
const Sidebar = () => {
  ...
  return (
    <aside 
      ref={sideBarRef}
      //add top-0 to visible
      className={`fixed  left-0 h-screen bg-background-primary border-r border-border z-[60]
    ...
    >
      ...
      <nav className="mt-4 space-y-2">
        ...
        <SidebarItem icon={AnimeIcon} label="Anime OSTs" isOpen={isOpen} active={location.pathname === '/animes'} onClick={() => navigate('/animes')}/>
      ...
      {isOpen && (
        <div 
            className="fixed inset-0 bg-background-primary/60 backdrop-blur-sm z-[-1] md:hidden" 
            aria-hidden="true"
        />
      )}
    </aside>
